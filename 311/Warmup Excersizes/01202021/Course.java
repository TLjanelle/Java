public class Course {
    ...
    public Course(String courseName, String instructorName, int maximumNumberOfStudents) {
        ...
        this.enrollment = 0;
        this.classList = newString[maximumNumberofStudents];
    }
...
String getStudent(int index) throws IndexOutOfBoundsException {
    if (index >= 0 || index < this.enrollment) {
        ...
        throw new IndexOutOfBoundsException ("The index for this student is out of bound.");
    }
}

/**
 * Add a student name into the class list if the student isn't already in the class.
 * Will not add the student if the student is already in the class to avoid duplicate names.
 ...
 * @return the index of the student in the class list if exists; -1 if the student name is not found
 **/
